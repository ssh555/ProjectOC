...
namespace ML.Engine.BuildingSystem.BuildingSocket
{
    public class BuildingSocket : MonoBehaviour
    {
        ...
        [LabelText("BPart位置偏移量"), FoldoutGroup("Transform"), SerializeField, ShowIf(@"this.IsCanRotate == true")]
        ...
        [LabelText("BPart旋转偏移量"), FoldoutGroup("Transform"), SerializeField, ShowIf(@"this.IsCanRotate == true")]
