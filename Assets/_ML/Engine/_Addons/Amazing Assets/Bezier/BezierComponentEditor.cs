...
public class BezierComponentEditor : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        for (int i = 0; i < bezierComponent.ctrlPoints.Count; i++) {
            ...
            Vector3 inTangentPoint = BezierComponent.TranslateBezierPos(bezierComponent,ctrlPoint.InTangent+ctrlPoint.position);
            Vector3 outTangentPoint = BezierComponent.TranslateBezierPos(bezierComponent,ctrlPoint.OutTangent+ctrlPoint.position);
