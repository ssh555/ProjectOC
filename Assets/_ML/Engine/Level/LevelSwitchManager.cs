...
namespace ML.Engine.Level
{
    ...
    public sealed class LevelSwitchManager :Manager.GlobalManager.IGlobalManager//, Timer.ITickComponent
    {
        ...
        public IEnumerator LoadSceneAsync(string sceneName, System.Action<string, string> preCallback = null, System.Action<string, string> postCallback = null, bool isDelay = false)
        {
            ...
            DispatchLevelResources(preSceneName, CurSceneName);
        ...
        //{
        //    ABJsonAssetProcessor<LevelResource[]> aBJAProcessor = new ABJsonAssetProcessor<LevelResource[]>(LevelTableDataABPath, TableName, (datas) =>
        //     {
        ...
        private void DispatchLevelResources(string pre, string cur)
        {
