...
namespace ProjectOC.WorkerNS.UI
{
    public class UIFeature : ML.Engine.UI.UIBasePanel<FeaturePanel>
    {
        ...
        {
            //FeatBuild.OnWorkerMoodChangeEvent -= RefreshMood;
            //if (FeatBuild.HaveWorker)
            //{
            //    FeatBuild.Worker.OnMoodChangeEvent -= RefreshMood;
            //}
        ...
        {
            //if (CurrentWorker != null && CurrentWorker != FeatBuild.Worker)
            //{
            //    if (FeatBuild.HaveWorker)
            //    {
            ...
            //            () =>
            //            {
            //                (FeatBuild as IWorkerContainer).SetWorker(CurrentWorker);
            //            }
            //        ));
            //    }
            //    else
