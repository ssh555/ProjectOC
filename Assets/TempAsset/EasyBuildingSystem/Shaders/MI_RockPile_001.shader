Shader "Unreal/MI_RockPile_001"
{
    Properties
    {
		...
		Material_Texture2D_1( "Normal Detail", 2D ) = "white" {}
		Material_Texture2D_2( "Normal Masked Detail", 2D ) = "white" {}
		Material_Texture2D_3( "Albedo", 2D ) = "white" {}
		Material_Texture2D_4( "Cover - Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "Cover - Noise", 2D ) = "white" {}
		Material_Texture2D_6( "RMA", 2D ) = "white" {}
		Material_Texture2D_7( "Cover - RHA", 2D ) = "white" {}
