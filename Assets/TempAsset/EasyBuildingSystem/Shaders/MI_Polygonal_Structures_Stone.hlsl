...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.800000);//Normal Power (Unknown) (Unknown) Brightness
	Material.ScalarExpressions[1] = float4(0.100000,0.000000,0.000000,0.000000);//Saturation Metallic (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = (Local6.rgb * Material.ScalarExpressions[0].w);
	MaterialFloat3 Local9 = (Local8 * Material.VectorExpressions[3].rgb);
	MaterialFloat Local10 = dot(Local9, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local11 = lerp(Local9,MaterialFloat3(Local10,Local10,Local10),MaterialFloat(Material.ScalarExpressions[1].x));
	MaterialFloat3 Local12 = saturate(Local11);
