...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.034047,0.072827,0.185045,1.000000);//Zenith Color
	Material.VectorExpressions[2] = float4(0.034047,0.072827,0.185045,0.000000);//(Unknown)
	Material.VectorExpressions[3] = float4(0.673814,0.674749,1.000000,1.000000);//Horizon color
	Material.VectorExpressions[4] = float4(0.673814,0.674749,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.672769,0.526155,-0.520136,1.000000);//Light direction
	Material.VectorExpressions[6] = float4(0.672769,0.526155,-0.520136,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(0.672769,0.526156,-0.520136,0.000000);//(Unknown)
	...
	Material.VectorExpressions[11] = float4(0.846600,0.761921,0.752505,1.000000);//Cloud color
	Material.VectorExpressions[12] = float4(0.846600,0.761921,0.752505,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.100000,0.000000,4.392951,1.000000);//Stars brightness Sun height Horizon Falloff (Unknown)
	Material.ScalarExpressions[1] = float4(1.000000,0.000300,0.000300,3333.333252);//(Unknown) Sun Radius (Unknown) (Unknown)
	Material.ScalarExpressions[2] = float4(75.000000,3.000000,1.550000,4.000000);//Sun brightness Cloud speed Cloud opacity NoisePower2
