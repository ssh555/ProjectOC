...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.333333,0.312464,0.249855,1.000000);//Color
	Material.VectorExpressions[3] = float4(0.333333,0.312464,0.249855,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local5 = Texture2DSampleBias(Material_Texture2D_1, sampler_Material_Texture2D_1,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias);
	...
	PixelMaterialInputs.Roughness = Local5.rgb;
