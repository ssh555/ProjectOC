Shader "Unreal/MI_Dummy_Structures_Base"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Utility_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Utility_M", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Dummy_Structures_Base.hlsl"
