...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.911458,1.000000,0.992335,0.000000);//Tint
	Material.VectorExpressions[3] = float4(0.911458,1.000000,0.992335,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.700000,0.300000,0.000000);//Tiling Normal Strength (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.900000,0.000000,0.500000,1.000000);//Brightness Saturation Roughness Power Roughness Multiply
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, Local0, 1);
	MaterialFloat4 Local15 = Texture2DSampleBias(Material_Texture2D_2, sampler_Material_Texture2D_2,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 1);
	MaterialFloat Local17 = PositiveClampedPow(Local15.r.r,Material.ScalarExpressions[1].z);
	MaterialFloat Local18 = (Local17 * Material.ScalarExpressions[1].w);
	...
	PixelMaterialInputs.AmbientOcclusion = Local15.b.r;
