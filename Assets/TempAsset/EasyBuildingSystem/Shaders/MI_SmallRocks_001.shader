Shader "Unreal/MI_SmallRocks_001"
{
    Properties
    {
		...
		Material_Texture2D_3( "Cover - Albedo", 2D ) = "white" {}
		Material_Texture2D_4( "Cover - Noise", 2D ) = "white" {}
		Material_Texture2D_5( "RMA", 2D ) = "white" {}
		Material_Texture2D_6( "Cover - RHA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_SmallRocks_001.hlsl"
